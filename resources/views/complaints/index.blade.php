...
<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex items-center gap-8 justify-end mr-5">
                <a class="middle none center rounded-lg bg-pink-500 py-3 px-4 font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                    href="{{route('complaints.general',['room' => $room])}}"
                    >Create General Complaint</a>
                <a class="middle none center rounded-lg bg-pink-500 py-3 px-4 font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                    href="{{route('complaints.maintenance', ['room' => $room])}}"
                            ...
                            <table class="min-w-full">
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b">
                                        ...
                                        <td class="flex mt-2">
                                            <a href="{{route('complaints.show', ['complaint' => $comp, 'room'=> $room])}}"
