<x-app-layout>
    ...
    <div class="py-12">
        <div class="w-4/5 mx-auto sm:px-6 lg:px-8 flex items-center justify-center flex-col ">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg w-4/5 relative">
                <div class="p-6 text-gray-900 text-xl items-center justify-center flex">
                    {{ __('Schedules of appointment!') }}
                </div>
            </div>
                                    ...
                                    <tbody>
                                        @foreach ($schedules as $schedule)
                                            <tr>
                                                ...
                                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                    <p class="text-gray-900 whitespace-no-wrap">{{ $schedule->email }}
                                                    </p>
                                                </td>
                                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                    <p class="text-gray-900 whitespace-no-wrap">
                                                ...
                                                <td
                                                    ...
                                                    <form
                                                        action="{{ route('schedule.cancel', ['schedule' => $schedule]) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('PUT')
                                                        <button
                                                ...
                                                <td>
                                                    ...
                                                    <form
                                                        action="{{ route('schedule.accept', ['schedule' => $schedule]) }}"
                                                        method="post" class="fixed z-10 inset-0 overflow-y-auto hidden"
                                                        id="myModal">
                                                        @csrf
                                                        @method('PUT')
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="mt-2 flex flex-col gap-4">
                                                                            <label for="password"
                                                                                ...
                                                                                Plese add your password
                                                                            </label>
                                                                            <input type="text" id="passwordIp"
                                                                                name="password"
                                                                                placeholder="Add yout password "
