        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                   <img class="w-12 h-12" src="https://media.discordapp.net/attachments/1128653291283288159/1171219667885506681/Pngtreeapartment_ground_logo_6237449.png?ex=655be251&is=65496d51&hm=cbd7ebd937a7e87506cda9f553a290539b5d4695a10e774a10a1f6c544881190&=&width=671&height=671" alt="">
                </div>
                ...
                @if (Auth::user()->role == 'ADMIN')
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="route('contract.create')" :active="request()->routeIs('contract.create')">
                            {{ __('Add Room') }}
                        </x-nav-link>
                    </div>
